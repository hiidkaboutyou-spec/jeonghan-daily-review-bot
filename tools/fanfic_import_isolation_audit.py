...
"""Stage D audit for Fanfic/Daily shadow-stack isolation.

Import Linter owns static direct/indirect import-chain evidence. This companion
audit covers two gaps for the Fanfic boundary:
...
The audit is read-only and never imports manuscripts, contacts providers, or
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Audit the blocking Fanfic/Daily shadow-stack import isolation boundary."
    )
