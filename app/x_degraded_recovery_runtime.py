...
"""Runtime integration for Hani's degraded X recovery path.
...
def _install_outcome_classification() -> None:
    ...
    def classify_outcome_hardened(outcome):
        ...
        if (
            state.cursor_reason == "not_due_or_no_advance"
...
def install(application_cls: type[Any]) -> None:
    """Install degraded-X recovery integration on the final production application."""
