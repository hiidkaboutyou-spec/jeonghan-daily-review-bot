...
class ChannelStyleReviewApplication(TelegramSafeReviewApplication):
    ...
    a generic machine-transliteration spelling. Exact media delivery is deduplicated
    before Telegram upload, and polling offsets are confirmed only after processing.
    """
